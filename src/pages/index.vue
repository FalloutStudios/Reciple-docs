<template>
	...
	>
		<div class="col-span-full">
			<h2>About</h2>
			<p>
				Reciple.js is a simple command handler with message command (aka prefix command) and slash commands support.
			</p>
			<p>
				Reciple makes discord.js command handling simple and cleaner using out built in CLI tool.
			</p>
		</div>
		<div>
			<h2>Why?</h2>
